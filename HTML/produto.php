    ...
    <body>
        <header>
            ...
            <ul class="navbar">
                ...
                <li><a href="preco.php">Produtos</a></li>
                ...
                <div class="preco">
                    <div class="esquerda">
                        <div class="preco-text">
                            <h1>Nossos Produtos <br> Estão aqui!</h1>
                    ...
                    <div class="products-container">
                        <div class="direita">
                            <div class="box">
                                <img src="../IMAGENS/maquininha.png" alt="">
                                <h3>Maquininha silenciosa</h3>
                                <div class="content">
                                    <span>R$20,00</span>
                                    <a href="#">Pague agora</a>
                                </div>
